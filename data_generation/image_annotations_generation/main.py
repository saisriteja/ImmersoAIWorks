...
class CaptioningPipeline:
    ...
    def process_images(self):
        ...
        for img_path in image_paths:
            ...
            captions[img_path] = caption_conditional  # You can change this to unconditional if preferred.
    ...
    def write_to_json(self, captions, metadata):
        ...
        print(f"Finished processing {metadata['total_no_of_images']} images. Output saved to {self.output_path}.")
